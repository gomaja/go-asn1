...
func (v *EHRPDCompositeAvailableCapacity) MarshalAPERTo(bb *per.BitBuffer) error {
	...
	if err := per.EncodeIntegerAligned(bb, int64(v.EHRPDSectorCapacityClassValue), int64Ptr(1), int64Ptr(100), false); err != nil {
...
func (v *EHRPDCompositeAvailableCapacity) UnmarshalAPERFrom(bb *per.BitBuffer) error {
	...
	val_ehrpdsectorcapacityclassvalue, err := per.DecodeIntegerAligned(bb, int64Ptr(1), int64Ptr(100), false)
	if err != nil {
