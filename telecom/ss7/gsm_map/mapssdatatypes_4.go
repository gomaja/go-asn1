...
// RegisterSSArg4 represents the ASN.1 type RegisterSSArg4 (SEQUENCE).
...
// NoReplyConditionTime4 represents the ASN.1 type NoReplyConditionTime4 (INTEGER).
...
// SSInfo4 represents the ASN.1 CHOICE type SSInfo4.
type SSInfo4 struct {
	Choice          int
...
// ForwardingInfo4 represents the ASN.1 type ForwardingInfo4 (SEQUENCE).
...
// ForwardingFeatureList4 represents the ASN.1 type ForwardingFeatureList4 (SEQUENCE_OF).
type ForwardingFeatureList4 = []ForwardingFeature4

// ForwardingFeature4 represents the ASN.1 type ForwardingFeature4 (SEQUENCE).
...
// SSStatus4 represents the ASN.1 type SSStatus4 (OCTET_STRING).
type SSStatus4 = []byte

// ForwardingOptions4 represents the ASN.1 type ForwardingOptions4 (OCTET_STRING).
type ForwardingOptions4 = []byte

// CallBarringInfo4 represents the ASN.1 type CallBarringInfo4 (SEQUENCE).
...
// CallBarringFeatureList4 represents the ASN.1 type CallBarringFeatureList4 (SEQUENCE_OF).
type CallBarringFeatureList4 = []CallBarringFeature4

// CallBarringFeature4 represents the ASN.1 type CallBarringFeature4 (SEQUENCE).
...
// SSData4 represents the ASN.1 type SSData4 (SEQUENCE).
type SSData4 struct {
	SsCode                      *SSCode4               `asn1:",optional" json:"SsCode,omitempty"`
	SsStatus                    *SSStatus4             `asn1:"tag:4,context,implicit,optional" json:"SsStatus,omitempty"`
...
// SSSubscriptionOption4 represents the ASN.1 CHOICE type SSSubscriptionOption4.
...
// CliRestrictionOption4 represents the ASN.1 ENUMERATED type CliRestrictionOption4.
...
// OverrideCategory4 represents the ASN.1 ENUMERATED type OverrideCategory4.
...
// SSForBSCode4 represents the ASN.1 type SSForBSCode4 (SEQUENCE).
...
// GenericServiceInfo4 represents the ASN.1 type GenericServiceInfo4 (SEQUENCE).
...
// CCBSFeatureList4 represents the ASN.1 type CCBSFeatureList4 (SEQUENCE_OF).
type CCBSFeatureList4 = []CCBSFeature4

// CCBSFeature4 represents the ASN.1 type CCBSFeature4 (SEQUENCE).
...
// CCBSIndex4 represents the ASN.1 type CCBSIndex4 (INTEGER).
...
// InterrogateSSRes4 represents the ASN.1 CHOICE type InterrogateSSRes4.
...
// USSDArg4 represents the ASN.1 type USSDArg4 (SEQUENCE).
...
// USSDRes4 represents the ASN.1 type USSDRes4 (SEQUENCE).
...
// USSDDataCodingScheme4 represents the ASN.1 type USSDDataCodingScheme4 (OCTET_STRING).
type USSDDataCodingScheme4 = []byte

// USSDString4 represents the ASN.1 type USSDString4 (OCTET_STRING).
type USSDString4 = []byte

// Password4 represents the ASN.1 type Password4 (NumericString).
type Password4 = string

// GuidanceInfo4 represents the ASN.1 ENUMERATED type GuidanceInfo4.
...
// SSList4 represents the ASN.1 type SSList4 (SEQUENCE_OF).
type SSList4 = []SSCode4

// SSInfoList4 represents the ASN.1 type SSInfoList4 (SEQUENCE_OF).
type SSInfoList4 = []SSInfo4

// BasicServiceGroupList4 represents the ASN.1 type BasicServiceGroupList4 (SEQUENCE_OF).
type BasicServiceGroupList4 = []BasicServiceCode4

// SSInvocationNotificationArg4 represents the ASN.1 type SSInvocationNotificationArg4 (SEQUENCE).
...
// CCBSRequestState4 represents the ASN.1 ENUMERATED type CCBSRequestState4.
...
// SSInvocationNotificationRes4 represents the ASN.1 type SSInvocationNotificationRes4 (SEQUENCE).
...
// SSEventSpecification4 represents the ASN.1 type SSEventSpecification4 (SEQUENCE_OF).
type SSEventSpecification4 = []AddressString4

// RegisterCCEntryArg4 represents the ASN.1 type RegisterCCEntryArg4 (SEQUENCE).
...
// CCBSData4 represents the ASN.1 type CCBSData4 (SEQUENCE).
...
// ServiceIndicator4 represents the ASN.1 type ServiceIndicator4 (BIT_STRING).
type ServiceIndicator4 = runtime.BitString

// RegisterCCEntryRes4 represents the ASN.1 type RegisterCCEntryRes4 (SEQUENCE).
...
// EraseCCEntryArg4 represents the ASN.1 type EraseCCEntryArg4 (SEQUENCE).
...
// EraseCCEntryRes4 represents the ASN.1 type EraseCCEntryRes4 (SEQUENCE).
...
func (v *InterrogateSSRes4) MarshalBER() ([]byte, error) {
	...
	case InterrogateSSRes4ChoiceBasicServiceGroupList:
		if v.BasicServiceGroupList == nil {
			return nil, fmt.Errorf("choice InterrogateSSRes4: basicServiceGroupList is nil")
		}
	...
	case InterrogateSSRes4ChoiceForwardingFeatureList:
		if v.ForwardingFeatureList == nil {
			return nil, fmt.Errorf("choice InterrogateSSRes4: forwardingFeatureList is nil")
		}
