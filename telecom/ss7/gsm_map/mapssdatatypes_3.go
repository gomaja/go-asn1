...
// RegisterSSArg3 represents the ASN.1 type RegisterSSArg3 (SEQUENCE).
...
// NoReplyConditionTime3 represents the ASN.1 type NoReplyConditionTime3 (INTEGER).
...
// SSInfo3 represents the ASN.1 CHOICE type SSInfo3.
type SSInfo3 struct {
	Choice          int
...
// ForwardingInfo3 represents the ASN.1 type ForwardingInfo3 (SEQUENCE).
...
// ForwardingFeatureList3 represents the ASN.1 type ForwardingFeatureList3 (SEQUENCE_OF).
type ForwardingFeatureList3 = []ForwardingFeature3

// ForwardingFeature3 represents the ASN.1 type ForwardingFeature3 (SEQUENCE).
...
// SSStatus3 represents the ASN.1 type SSStatus3 (OCTET_STRING).
type SSStatus3 = []byte

// ForwardingOptions3 represents the ASN.1 type ForwardingOptions3 (OCTET_STRING).
type ForwardingOptions3 = []byte

// CallBarringInfo3 represents the ASN.1 type CallBarringInfo3 (SEQUENCE).
...
// CallBarringFeatureList3 represents the ASN.1 type CallBarringFeatureList3 (SEQUENCE_OF).
type CallBarringFeatureList3 = []CallBarringFeature3

// CallBarringFeature3 represents the ASN.1 type CallBarringFeature3 (SEQUENCE).
...
// SSData3 represents the ASN.1 type SSData3 (SEQUENCE).
type SSData3 struct {
	SsCode                      *SSCode3               `asn1:",optional" json:"SsCode,omitempty"`
	SsStatus                    *SSStatus3             `asn1:"tag:4,context,implicit,optional" json:"SsStatus,omitempty"`
...
// SSSubscriptionOption3 represents the ASN.1 CHOICE type SSSubscriptionOption3.
...
// CliRestrictionOption3 represents the ASN.1 ENUMERATED type CliRestrictionOption3.
...
// OverrideCategory3 represents the ASN.1 ENUMERATED type OverrideCategory3.
...
// SSForBSCode3 represents the ASN.1 type SSForBSCode3 (SEQUENCE).
...
// GenericServiceInfo3 represents the ASN.1 type GenericServiceInfo3 (SEQUENCE).
...
// CCBSFeatureList3 represents the ASN.1 type CCBSFeatureList3 (SEQUENCE_OF).
type CCBSFeatureList3 = []CCBSFeature3

// CCBSFeature3 represents the ASN.1 type CCBSFeature3 (SEQUENCE).
...
// CCBSIndex3 represents the ASN.1 type CCBSIndex3 (INTEGER).
...
// InterrogateSSRes3 represents the ASN.1 CHOICE type InterrogateSSRes3.
...
// USSDArg3 represents the ASN.1 type USSDArg3 (SEQUENCE).
...
// USSDRes3 represents the ASN.1 type USSDRes3 (SEQUENCE).
...
// USSDDataCodingScheme3 represents the ASN.1 type USSDDataCodingScheme3 (OCTET_STRING).
type USSDDataCodingScheme3 = []byte

// USSDString3 represents the ASN.1 type USSDString3 (OCTET_STRING).
type USSDString3 = []byte

// Password3 represents the ASN.1 type Password3 (NumericString).
type Password3 = string

// GuidanceInfo3 represents the ASN.1 ENUMERATED type GuidanceInfo3.
...
// SSList3 represents the ASN.1 type SSList3 (SEQUENCE_OF).
type SSList3 = []SSCode3

// SSInfoList3 represents the ASN.1 type SSInfoList3 (SEQUENCE_OF).
type SSInfoList3 = []SSInfo3

// BasicServiceGroupList3 represents the ASN.1 type BasicServiceGroupList3 (SEQUENCE_OF).
type BasicServiceGroupList3 = []BasicServiceCode3

// SSInvocationNotificationArg3 represents the ASN.1 type SSInvocationNotificationArg3 (SEQUENCE).
...
// CCBSRequestState3 represents the ASN.1 ENUMERATED type CCBSRequestState3.
...
// SSInvocationNotificationRes3 represents the ASN.1 type SSInvocationNotificationRes3 (SEQUENCE).
...
// SSEventSpecification3 represents the ASN.1 type SSEventSpecification3 (SEQUENCE_OF).
type SSEventSpecification3 = []AddressString3

// RegisterCCEntryArg3 represents the ASN.1 type RegisterCCEntryArg3 (SEQUENCE).
...
// CCBSData3 represents the ASN.1 type CCBSData3 (SEQUENCE).
...
// ServiceIndicator3 represents the ASN.1 type ServiceIndicator3 (BIT_STRING).
type ServiceIndicator3 = runtime.BitString

// RegisterCCEntryRes3 represents the ASN.1 type RegisterCCEntryRes3 (SEQUENCE).
...
// EraseCCEntryArg3 represents the ASN.1 type EraseCCEntryArg3 (SEQUENCE).
...
// EraseCCEntryRes3 represents the ASN.1 type EraseCCEntryRes3 (SEQUENCE).
...
func (v *InterrogateSSRes3) MarshalBER() ([]byte, error) {
	...
	case InterrogateSSRes3ChoiceBasicServiceGroupList:
		if v.BasicServiceGroupList == nil {
			return nil, fmt.Errorf("choice InterrogateSSRes3: basicServiceGroupList is nil")
		}
	...
	case InterrogateSSRes3ChoiceForwardingFeatureList:
		if v.ForwardingFeatureList == nil {
			return nil, fmt.Errorf("choice InterrogateSSRes3: forwardingFeatureList is nil")
		}
